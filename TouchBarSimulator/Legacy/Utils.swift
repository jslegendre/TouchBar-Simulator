...
extension Collection where Element == _DefaultsObservation {
    @discardableResult
...
extension Defaults {
    static func tiedToLifetime(of weaklyHeldObject: AnyObject, @ArrayBuilder<_DefaultsObservation> _ observations: () -> [_DefaultsObservation]) {
